...
```
你说得对，但是《四个铁心脏》是由paradox制作发行的一款著名的魔幻类地图填色游戏。游戏发生在一个被称作「OTL」的幻想世界，在这里，被玩家选中的国家将被授予「一营骑兵」，导引空降之力。你将扮演一位名为「国家意志」的神秘角色，在第二次世界大战中邂逅国策各异、民族精神独特的色块们，和他们一起击败其他的色块，把地图染成同一个颜色——同时，逐步发掘「Paradox到底是用哪只脚填的数值」的真相。